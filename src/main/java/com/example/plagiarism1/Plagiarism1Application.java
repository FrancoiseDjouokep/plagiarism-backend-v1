...
public class Plagiarism1Application implements CommandLineRunner {

	private static final Logger log = LoggerFactory.getLogger(Plagiarism1Application.class);

	private final UtilisateurRepository utilisateurRepository;
	private final RoleRepository roleRepository;
	private final PasswordEncoder passwordEncoder;

	public Plagiarism1Application(UtilisateurRepository utilisateurRepository,
	...
	public void run(String... args) {
		try {
			...
			// Refresh the role entity to ensure it's managed
			...
			if (!utilisateurRepository.existsByEmail(adminEmail)) {
				...
				admin.setActif(true);
				admin.setRole(adminRole); // Now using a managed entity

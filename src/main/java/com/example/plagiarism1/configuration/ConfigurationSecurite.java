    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/verifier-email").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/admin/pending-users").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/admin/valider-inscription/{pendingUserId}").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/admin/rejeter-inscription/{pendingUserId}").hasAuthority("ROLE_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "api/analysis/my-analyses").permitAll()
